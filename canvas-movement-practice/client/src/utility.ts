import { BuffKey, PlayerType } from ".";
/*
const uuid = () =>
...
export const getMapOffset = (myPlayer: PlayerType, canW: number, canH: number, TILE_SIZE: number, mapLen: number) => {
...
export function isNonEmptyObj<T>(obj: any): obj is T {
